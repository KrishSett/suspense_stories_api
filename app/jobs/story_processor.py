...
def download_audio_and_get_info(channel_id: str, file_path: str, file_name: str, user_email: str):
    def task():
        ...
        try:
            ...
            audio_stories_service.mark_ready(channel_id=channel_id, file_path=file_path, meta_info=meta_info)

            # Send Email Notification
            audio_notification = AudioStoryNotification()
            audio_notification.notify(
                user_email,
                {
